      ...
      <html>
        ...
        <body>
            <div
                ...
                <div
                    sytle="height: 60px; background: #393d49; line-height:60px; color:#58a36f; font-size: 18px; padding-left: 10px;">
                    Imooc社区————欢迎来到官方社区</div>
                <div sytle="padding: 25px">
                    <div> 您好，${sendInfo.user}同学，重置链接的有效时间30分钟，请在${sendInfo.expire}之前重置您 的密码</div>
                    <a href="${url}"
                        style="padding: 10px 20px; color:#fff; background: #009e94; display: inline-block; margin:15px 0 ;">重置密码</a>
